...
It is worth noting that [[https://turtleware.eu/posts/Conformal-array-displacement.html][conformally displaced arrays]] with a
multi-dimensional fill pointer would save us work with adjusting the
array. Another noteworthy thing is that a virtual buffer without a
specialization may be used in a buffered mode and it will have its
contents drawn without any output sink.
